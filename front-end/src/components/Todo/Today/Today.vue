<template>
  <div class="today__div__big">
    <div class="today__title">
      <h1>Today</h1>
      <p>{{completedTasks.length}}/{{ this.tasks.length }} completed</p>
    </div>
    <div class="today__tasks">
      <div class="task df" v-for="task in tasks" :key="task.id">
        ...
        <div class="task__text__crud df_jscpb_ai">
          ...
          <div class="task__crud df">
            <div class="task__edit" @click="editPopupOpen(task)">
  ...
  <div class="modal-vue">
    ...
    <div class="modal" v-if="showModal">
      ...
      <h3>Are you sure?</h3>
      <p>Are you sure you want to delete these tasks?
        After removal
  ...
  <div class="modal-vue">
    ...
    <div class="modal" v-if="showModalEdit">
      <button class="close" @click="showModalEdit = false">x</button>
      <h3>Edit</h3>
